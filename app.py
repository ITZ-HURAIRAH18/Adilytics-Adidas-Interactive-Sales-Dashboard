import streamlit as st  # Streamlit is used for building interactive web applications for data visualization and dashboards
import pandas as pd   #for data handling 
import datetime
from PIL import Image
import plotly.express as px  ## interactive data visual lization
import plotly.graph_objects as go


#read the data from excel file
df=pd.read_excel('Adidas.xlsx')
st.set_page_config( layout="wide")  # Set the title and icon of the Streamlit app
st.markdown('<style>div.block-container{padding-top:1rem;}</style>', unsafe_allow_html=True)# Set the title and icon of the Streamlit app
image=Image.open('adidas-logo.jpg')  # Load an image from a file
...
_, view1, dwn1, view2, dwn2 = st.columns([0.15,0.20,0.1,0.20,0.20])
with view1:
